...
def random_date():
    return str(randint(1999, 2020))+"-"+str(randint(1, 12))+"-"+str(randint(1, 28))
...
for i in range(30):
    ...
    s = [i, random_patient_id(), randodm_poids(),
        random_unite(), date_it(random_date()), randint(1, 2), str(random_medicament())]
    c._ADD_SESSION(*s, True, "")
    c._ADD_TEST(i, random_patient_id(), date_it(random_date()), random_review(), random_name())
print(time.time() - t)